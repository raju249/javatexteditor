...
public class MyLinkedListTester {
	...
	public void testAddEnd()
	{
		...
		boolean value = emptyList.add(0);
		assertEquals("Check AddEnd value",true,value);
		assertEquals("Check AddEnd Data",(Integer)0,emptyList.get(0));
		assertEquals("Check AddEnd Size",1,emptyList.size());
		
		value = emptyList.add(1);
		assertEquals("Check AddEnd value",true,value);
		assertEquals("Check AddEnd Data",(Integer)1,emptyList.get(1));
		assertEquals("Check AddEnd Size",2,emptyList.size());
	}
